...
@Component({
  selector: 'nx-papelsa-devolucion-partidas-table',
  templateUrl: './devolucion-partidas-table.component.html',
  styleUrls: ['./devolucion-partidas-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DevolucionPartidasTableComponent implements OnInit {
