...
class PapwsCallcenterMigrationService {
  ...
  void exportarUsuario(String username) {
    User user = User.findByUsername(username)
    Map<String, Object> data = [
      email: null,
      displayName: user.nombres + ' ' + user.apellidoPaterno,
      nombre: user.nombre,
      numeroDeEmpleado: user.numeroDeEmpleado,
    ...
    log.info('User {} exported to firebase at: {}', user.username, result.get().updateTime)
